...
function MainPage() {
    ...
    return (
        <div className='flex flex-col justify-between w-full min-h-screen'>
            <Header />
            <div className='text-custom-text shadow-none max-w-screen-xl min-h-[85vh] lg:min-h-[50vh] self-center lg:p-8 m-4 bg-custom-light bg-opacity-85 backdrop-blur-md rounded-lg card'>
